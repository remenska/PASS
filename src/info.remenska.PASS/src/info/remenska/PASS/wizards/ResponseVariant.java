...
public class ResponseVariant extends PropertyPattern {
	Model m;

	public ResponseVariant(Model m) {
		this.m = m;
	}
	...
	public void draw(int scope) {
		...
		case PropertyPattern.BEFORE:
			draw_beforeRResponseVariant(m);
			break;
		case PropertyPattern.AFTER:
			draw_afterQResponseVariant(m);
			break;
		case PropertyPattern.AFTER_LAST:
			draw_afterLastQResponseVariant(m);
			break;

		case PropertyPattern.BETWEEN:
			draw_betweenQandRResponseVariant(m);
			break;

		case PropertyPattern.UNTIL:
			draw_UntilRResponseVariant(m);
			break;
		case PropertyPattern.AFTER_UNTIL:
			draw_afterQUntilRResponseVariant(m);
			break;

		case PropertyPattern.GLOBALLY:
			draw_globallyResponseVariant(m);
			break;
			
		case PropertyPattern.AFTER_LAST_UNTIL:
			draw_afterLastQUntilRResponseVariant(m);
			break;
			
		case PropertyPattern.BETWEEN_LAST:
			draw_betweenLastQandRResponseVariant(m);
			break;
		}
	}

	public void draw_betweenLastQandRResponseVariant(Model m2) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BetweenLastQandR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BetweenLastQandR_ResponseVariant_Pattern_" + random,
		...
		d.setName("Diag_SD_BetweenLastQandR_ResponseVariant_Pattern_" + random);
		...
		cd.setName("Diag_COM_BetweenLastQandR_ResponseVariant_Pattern_" + random);		
	}

	public void draw_afterLastQUntilRResponseVariant(Model m2) {

		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterLastQUntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterLastQUntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterLastQUntilR_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterLastQUntilR_ResponseVariant_Pattern_" + random);		
	}

	public void draw_afterLastQResponseVariant(Model m2) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterLastQ_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterLastQ_AbsenceVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterLastQ_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterLastQ_ResponseVariant_Pattern_" + random);		
	}

	public void draw_UntilRResponseVariant(Model m2) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_UntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_UntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_UntilR_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_UntilR_ResponseVariant_Pattern_" + random);		
	}

	public void draw_beforeRResponseVariant(Model m) {

		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BeforeR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_Before_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BeforeR_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BeforeR_ResponseVariant_Pattern_" + random);
	}

	public void draw_afterQUntilRResponseVariant(Model m) {

		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterQUntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterQUntilR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterQUntilR_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterQUntilR_ResponseVariant_Pattern_" + random);

	}

	public void draw_afterQResponseVariant(Model m) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterQ_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterQ_AbsenceVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterQ_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterQ_ResponseVariant_Pattern_" + random);
	}

	public void draw_globallyResponseVariant(Model m) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_Globally_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_Globally_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_Globally_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_Globally_ResponseVariant_Pattern_" + random);

	}

	public void draw_betweenQandRResponseVariant(Model m) {
		int random = (int) (Math.random() * 5000 + 1);

		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BetweenQandR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BetweenQandR_ResponseVariant_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		response(m, coll, inter);
		beforeR(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BetweenQandR_ResponseVariant_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BetweenQandR_ResponseVariant_Pattern_" + random);
	}
	...
	public void existence(Model m, Collaboration coll, Interaction inter,
		...
		//add the parameter values, as specified in PASS, to the message
		if (m1.getMessageSort().getLiteral().equals("reply")) {
			String[] returnParams = QuestionTreePage.traceLineMap.get(textEvent).getReturnParams();
			for(String param:returnParams){
				OpaqueExpression mh = (OpaqueExpression) m1.createArgument("param", null,UMLPackage.Literals.OPAQUE_EXPRESSION);
				mh.getBodies().add(param);
			}
			
		} else {
			String[] params = QuestionTreePage.traceLineMap.get(textEvent).getParameters();
	...
	public void regMessage(Model m, Collaboration coll, Interaction inter,
		...
		if (m1B.getMessageSort().getLiteral().equals("reply")) {
			String[] returnParams = QuestionTreePage.traceLineMap.get(textEvent).getReturnParams();
			for(String param:returnParams){
				OpaqueExpression mh = (OpaqueExpression) m1B.createArgument("param", null,UMLPackage.Literals.OPAQUE_EXPRESSION);
				mh.getBodies().add(param);
			}
