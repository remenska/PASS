...
public class Absence extends PropertyPattern {
	...
	public void absence(Model m, Collaboration coll, Interaction inter) {
		...
		if (m1.getMessageSort().getLiteral().equals("reply")) {
			String[] returnParams = QuestionTreePage.traceLineMap.get(QuestionTreePage.textEventA).getReturnParams();
			...
			String[] params = QuestionTreePage.traceLineMap.get(QuestionTreePage.textEventA).getParameters();
