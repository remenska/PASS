...
public class Universality extends PropertyPattern {
	Model m;

	public Universality(Model m) {
		this.m = m;
	}
	...
	public void draw_betweenLastQandRExistence(Model m2) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BetweenLastQandR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BetweenLastQandR_Universality_Pattern_" + random,
		...
		d.setName("Diag_SD_BetweenLastQandR_Universality_Pattern_" + random);
		...
		cd.setName("Diag_COM_BetweenLastQandR_Universality_Pattern_" + random);
	...
	public void draw_afterLastQUntilRExistence(Model m2) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterLastQUntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterLastQUntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterLastQUntilR_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterLastQUntilR_Universality_Pattern_" + random);
	}
	...
	public void draw_afterLastQExistence(Model m2) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterLastQ_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterLastQ_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterLastQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterLastQ_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterLastQ_Universality_Pattern_" + random);		
	}
	...
	public void draw_UntilRExistence(Model m2) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_UntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_UntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_UntilR_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_UntilR_Universality_Pattern_" + random);
	...
	public void draw_beforeRExistence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BeforeR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BeforeR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BeforeR_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BeforeR_Universality_Pattern_" + random);
	...
	public void draw_afterQUntilRExistence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterQUntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterQUntilR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterQUntilR_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterQUntilR_Universality_Pattern_" + random);
	...
	public void draw_afterQExistence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_AfterQ_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_AfterQ_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_AfterQ_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_AfterQ_Universality_Pattern_" + random);
	}
	...
	public void draw_globallyExistence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_Globally_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_Globally_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_Globally_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_Globally_Universality_Pattern_" + random);
	}
	...
	public void draw_betweenQandRExistence(Model m) {
		...
		Collaboration coll = (Collaboration) m.createPackagedElement(
				"Collab_BetweenQandR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getCollaboration());
		Interaction inter = (Interaction) coll.createOwnedBehavior(
				"Inter_BetweenQandR_Universality_Pattern_" + random,
				UMLPackage.eINSTANCE.getInteraction());
		afterQ(m, coll, inter);
		existence(m, coll, inter, QuestionTreePage.textEventA);
		beforeR(m, coll, inter);
		...
		Diagram d = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.SEQUENCE_LITERAL, inter);
		d.setName("Diag_SD_BetweenQandR_Universality_Pattern_" + random);
		UMLModeler.getUMLDiagramHelper().openDiagramEditor(d);

		Diagram cd = UMLModeler.getUMLDiagramHelper().createDiagram(inter,
				UMLDiagramKind.COMMUNICATION_LITERAL, inter);
		cd.setName("Diag_COM_BetweenQandR_Universality_Pattern_" + random);
	...
	public void existence(Model m, Collaboration coll, Interaction inter,
		...
		// QuestionTreePage.traceLineMap.get(textEvent).getParameters(); <-- this is how to add parameters
